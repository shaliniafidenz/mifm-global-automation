...
/**
 * Test data for CWO Filter test suite.
 *
...
module.exports = {
    ...
    // ── Expected UI text ────────────────────────────────────────────────────────
    expectedFilterTitle: 'Filter Corrective Work Order',
    expectedCwoTitle:    'Corrective Work Order',
    ...
    // ── Primary building used by TC01 – TC14 ────────────────────────────────────
    defaultBuilding: {
        resourceId: 'cwo_filter_buildingItems_dropdown_list_item_1',
        name:       'Certis(Site).CW',
    },

    // ── Alternate building used by TC15 (Service Category scenario) ─────────────
    tc15Building: {
