...
/**
 * Page Object for the CWO Filter screen.
 *
 * Opened by tapping cwo_filter_button on the CWO landing page.
...
class CWOFilterPage {
    ...
    get buildingDropdown() {
        return $(
            ...
            '.scrollIntoView(new UiSelector().resourceId("cwo_filter_building_dropdown"))'
        );
    }
    ...
    get floorDropdown() {
        return $(
            'android=new UiScrollable(new UiSelector().scrollable(true))' +
            '.scrollIntoView(new UiSelector().resourceId("cwo_filter_floor_dropdown"))'
        );
    }
    ...
    get spaceDropdown() {
        return $(
            'android=new UiScrollable(new UiSelector().scrollable(true))' +
            '.scrollIntoView(new UiSelector().resourceId("cwo_filter_space_dropdown"))'
        );
    }
    ...
    get assetDropdown() {
        return $(
            'android=new UiScrollable(new UiSelector().scrollable(true))' +
            '.scrollIntoView(new UiSelector().resourceId("cwo_filter_asset_dropdown"))'
        );
    }
    ...
    get serviceCategoryDropdown() {
        return $(
            'android=new UiScrollable(new UiSelector().scrollable(true))' +
            '.scrollIntoView(new UiSelector().resourceId("cwo_filter_serviceCategory_dropdown"))'
        );
    }

    // ── Assigned To toggles ─────────────────────────────────────────────────────
    get assignedToMeButton() {
        return $('android=new UiSelector().resourceId("cwo_filter_assignedTo_me_button")');
    }

    get assignedToAllButton() {
        return $('android=new UiSelector().resourceId("cwo_filter_assignedTo_all_button")');
    }
    ...
    /**
     * Selects a building option by its known resource ID
     * (e.g. 'cwo_filter_buildingItems_dropdown_list_item_1').
     */
...
module.exports = new CWOFilterPage();
